...
use App\Filament\Resources\HospitalServiceResource\Pages;
use App\Filament\Resources\HospitalServiceResource\RelationManagers;
...
class HospitalServiceResource extends Resource
{
    protected static ?string $model = HospitalService::class;
    ...
    {
        $countItems = HospitalServiceHasItem::count();
        ...
        return $table
                ...
                ToggleColumn::make('is_active')
                    ...
                    ->afterStateUpdated(function ($state, $record) {
                        ...
                        Notification::make()
                            ...
                            ->body("The Hospital service '{$record->title}' is now {$status}.")
            ...
            ->actions([
                Tables\Actions\Action::make('addItem')
                    ...
                    ->color('sucess')
                    // ->openUrlInNewTab()
                    ->url(fn ($record) => route('filament.admin.resources.hospital-service-has-items.index', ['hospital_service_id' => $record->id])),
    ...
    {
        return [
            'index' => Pages\ListHospitalServices::route('/'),
            // 'create' => Pages\CreateHospitalService::route('/create'),
            // 'edit' => Pages\EditHospitalService::route('/{record}/edit'),
        ];
    }
}
