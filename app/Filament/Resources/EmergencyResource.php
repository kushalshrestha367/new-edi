            ...
            Grid::make(2)
                ->schema([
                    ...
                    TextInput::make('icon')
                        ->label('Value Icon')
                        ->nullable()
                        ->placeholder('Example: <i class=fas fa-phone></i> --->')
                        ->suffixAction(
            ...
            ->columns([
                ...
                ToggleColumn::make('is_active')
                    ...
                    ->afterStateUpdated(function ($state, $record) {
                        ...
                        Notification::make()
                            ->title("Emergency Status Changed")
                            ->body("The Emergency '{$record->title}' is now {$status}.")
                    ...
                    Tables\Actions\BulkAction::make('toggleStatus')
                        ...
                        ->action(function (Collection $records) {
                            ...
                            Notification::make()
                                ...
                                ->body('Selected Emergencies updated.')
                                ->success()
                                ->send();
                        }),
