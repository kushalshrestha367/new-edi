...
class CareerPolicy
{
    ...
    {
        return $user->can('view_any_career::career');
    }
    ...
    {
        return $user->can('view_career::career');
    }
    ...
    {
        return $user->can('create_career::career');
    }
    ...
    {
        return $user->can('update_career::career');
    }
    ...
    {
        return $user->can('delete_career::career');
    }
    ...
    {
        return $user->can('delete_any_career::career');
    }
    ...
    {
        return $user->can('reorder_career::career');
    }
}
