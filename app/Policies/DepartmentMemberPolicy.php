...
class DepartmentMemberPolicy
{
    ...
    {
        return $user->can('view_any_department::member');
    }
    ...
    {
        return $user->can('view_department::member');
    }
    ...
    {
        return $user->can('create_department::member');
    }
    ...
    {
        return $user->can('update_department::member');
    }
    ...
    {
        return $user->can('delete_department::member');
    }
    ...
    {
        return $user->can('delete_any_department::member');
    }
     ...
     */
    public function replicate(User $user, DepartmentMember $departmentMember): bool
    {
    ...
    {
        return $user->can('reorder_department::member');
    }
}
