...
class ProgramCategoryPolicy
{
    ...
    {
        return $user->can('view_any_program::program::category');
    }
    ...
    {
        return $user->can('view_program::program::category');
    }
    ...
    {
        return $user->can('create_program::program::category');
    }
    ...
    {
        return $user->can('update_program::program::category');
    }
    ...
    {
        return $user->can('delete_program::program::category');
    }
    ...
    {
        return $user->can('delete_any_program::program::category');
    }
    ...
    {
        return $user->can('reorder_program::program::category');
    }
}
