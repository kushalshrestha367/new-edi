    ...
    <div class="min-h-screen">
        ...
        <footer class="mt-10 w-full border-t px-5 py-12">
            <div class="container mx-auto">
                            ...
                            <div class="md:flex md:flex-col grid gap-3 py-3 text-sm font-medium">
                                ...
                                @forelse($setting->quick_links ?? [] as $link)
                                    <a href="{{ $link['url'] }}"
                                        ...
                                        title="{{ $link['label'] }}">
                                        {{ \Illuminate\Support\Str::limit($link['label'], 40, '...') }}
                                    </a>
                                @empty
                                            ...
                                            <form method="post" action="{{ route('filamentblog.post.subscribe') }}">
                                                ...
                                                <div class="w-100 relative">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-{{ '['.@$site_setting->secondary_color.']' ?? 'primary' }} h-8 w-8"
                                                            viewBox="0 0 256 256">
                ...
                <div class="mt-7 mb-10 sm:mb-0 flex flex-wrap items-start justify-center gap-10 border-t border-slate-200 pt-5">
                    <div class="text-hurricane/50 text-sm font-medium">
                        © 2026
                        {{ date('Y') != '2026' ? '-'.date('Y') : '' }}
                        {{ $setting->organization_name ?? config('app.name') }}. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
