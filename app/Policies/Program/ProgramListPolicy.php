...
class ProgramListPolicy
{
    ...
    {
        return $user->can('view_any_program::program::list');
    }
    ...
    {
        return $user->can('view_program::program::list');
    }
    ...
    {
        return $user->can('create_program::program::list');
    }
    ...
    {
        return $user->can('update_program::program::list');
    }
    ...
    {
        return $user->can('delete_program::program::list');
    }
    ...
    {
        return $user->can('delete_any_program::program::list');
    }
     ...
     */
    public function replicate(User $user, ProgramList $programList): bool
    {
    ...
    {
        return $user->can('reorder_program::program::list');
    }
}
