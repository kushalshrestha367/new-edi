...
namespace App\Policies\Downloads;
...
class DownloadPolicy
{
    ...
    {
        return $user->can('view_any_downloads::download');
    }
    ...
    {
        return $user->can('view_downloads::download');
    }
    ...
    {
        return $user->can('create_downloads::download');
    }
    ...
    {
        return $user->can('update_downloads::download');
    }
    ...
    {
        return $user->can('delete_downloads::download');
    }
    ...
    {
        return $user->can('delete_any_downloads::download');
    }
    ...
    {
        return $user->can('reorder_downloads::download');
    }
}
